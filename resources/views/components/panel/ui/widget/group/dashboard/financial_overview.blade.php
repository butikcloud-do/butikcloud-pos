...
<div class="row responsive-row">
                                        ...
                                        <div class="widget-card-left">
                                            ...
                                            <div class="widget-card-content">
                                                ...
                                                <h6 class="widget-amount">
                                                    {{ gs('cur_sym',getParentUser()->id) }}{{ showAmount($widget['total_deposit_amount'], currencyFormat: false) }}
                                    ...
                                    <div class="widget-card widget--warning">
                                        ...
                                        <div class="widget-card-left">
                                            ...
                                            <div class="widget-card-content">
                                                ...
                                                <h6 class="widget-amount">
                                                    {{ gs('cur_sym',getParentUser()->id) }}{{ showAmount($widget['total_deposit_pending'], currencyFormat: false) }}
                                                    <span class="currency">{{ __(gs('cur_text', getParentUser()->id)) }}</span>
                                                </h6>
                                            </div>
                                        </div>
                                    ...
                                    <div class="widget-card widget--danger">
                                        ...
                                        <div class="widget-card-left">
                                            ...
                                            <div class="widget-card-content">
                                                ...
                                                <h6 class="widget-amount">
                                                    {{ gs('cur_sym',getParentUser()->id) }}{{ showAmount($widget['total_deposit_rejected'], currencyFormat: false) }}
                                                    <span class="currency">{{ __(gs('cur_text', getParentUser()->id)) }}</span>
                                                </h6>
                                            </div>
                                        </div>
                                    ...
                                    <div class="widget-card widget--primary">
                                        ...
                                        <div class="widget-card-left">
                                            ...
                                            <div class="widget-card-content">
                                                ...
                                                <h6 class="widget-amount">
                                                    {{ gs('cur_sym',getParentUser()->id) }}{{ showAmount($widget['total_deposit_charge'], currencyFormat: false) }}
                                                    <span class="currency">{{ __(gs('cur_text', getParentUser()->id)) }}</span>
                                                </h6>
                                            </div>
                                        </div>
    ...
    <div class="col-xxl-6">
        <x-panel.ui.card class="shadow-none h-100 dw-card">
            <x-panel.ui.card.header class="flex-between py-3 gap-2">
                <h5 class="card-title mb-0 fs-16">@lang('Deposit Report')</h5>
    ...
    <script>
        ...
        (function($) {
            ...
            let dwChart = barChart(
                ...
                @json(__(gs('cur_text',getParentUser()->id))),
                [{
                        name: 'Deposited',
                        data: []
                    }
            ...
            const depositWithdrawChart = (startDate, endDate) => {
                ...
                $.get(url, data,
                    function(data, status) {
                        if (status == 'success') {
                            const updatedData = ['Deposited'].map(name => ({
                                name,
