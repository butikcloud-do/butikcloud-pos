<div class="row responsive-row">
    <div class="col-xxl-3 col-sm-6">
        <x-panel.ui.widget.four :url="route('admin.users.all')" variant="primary" title="Total Users" :value="$widget['all']"
            icon="las la-users" :currency=false />
    </div>
    <div class="col-xxl-3 col-sm-6">
        <x-panel.ui.widget.four url="{{ route('admin.users.all') }}?date={{ now()->toDateString() }}" variant="danger"
