<div class="col-sm-6">
    <x-panel.ui.widget.four url="javascript:void(0)" icon="fas fa-list" :title="$viaText . ' should be sent'"
        value="{{ @$sessionData['total_user'] }}" variant="primary" :currency=false />
</div>
<div class="col-sm-6">
    <x-panel.ui.widget.four url="javascript:void(0)" icon="fa-solid fa-envelope-circle-check" :title="$viaText . ' has been sent'"
        value="{{ @$sessionData['total_sent'] }}" variant="success" :currency=false />
</div>
<div class="col-sm-6">
    <x-panel.ui.widget.four url="javascript:void(0)" icon="fa-solid fa-paper-plane" :title="$viaText . ' has yet to be sent'" :currency=false
        value="{{ @$sessionData['total_user'] - @$sessionData['total_sent'] }}" variant="warning" />
</div>
<div class="col-sm-6">
    <x-panel.ui.widget.four url="javascript:void(0)" icon="fas fa-envelope" :title="$viaText . ' per batch'"
        value="{{ @$sessionData['batch'] }}" variant="primary" :currency=false />
</div>

<div class="col-12">
    <x-panel.ui.card>
        <x-panel.ui.card.body class="p-5 text-center">
