...
@section('panel')
    <div class="row responsive-row">
        <div class="col-12">
            <x-panel.ui.card>
                <x-panel.ui.card.header class="d-flex justify-content-between">
                    <div>
        ...
        @foreach ($messages as $message)
            <div class="col-12">
                @if ($message->admin_id == 0)
                    <x-panel.ui.card class="border--warning">
                        <x-panel.ui.card.header class="d-flex justify-content-between gap-2 flex-wrap align-items-center">
                            <div>
