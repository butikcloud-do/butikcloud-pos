...
@section('panel')
                        ...
                        <form action="{{ route('admin.frontend.manage.pages.update') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>&nbsp;</label>
                                        <x-panel.ui.btn.submit class="w-100" />
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <div class="row gy-3">
            ...
            <x-panel.ui.card class="h-100">
                ...
                <x-panel.ui.card.body>
                    ...
                    <form action="{{ route('admin.frontend.manage.section.update', $pData->id) }}" method="post">
                        ...
                        <div class=" mt-3">
                            <x-panel.ui.btn.submit text="Update" />
                        </div>
                    </form>
                </x-panel.ui.card.body>
            </x-panel.ui.card>
        ...
        <div class="col-lg-5">
            <x-panel.ui.card class="section-list-card h-100">
                <x-panel.ui.card.header>
...
@stop
@push('script-lib')
    <script src="{{ asset('assets/ovopanel/js/jquery-ui.min.js') }}"></script>
@endpush
...
@push('style')
    <style>
        ...
        [data-theme=dark] .sec-item li,
        [data-theme=dark] .vertical li {
