<div class="col-sm-6">
    <x-panel.ui.widget.four url="javascript:void(0)" icon="fas fa-list" title="Email should be sent"
        value="{{ @$sessionData['total_subscriber'] }}" variant="primary" :currency=false />
</div>
<div class="col-sm-6">
    <x-panel.ui.widget.four url="javascript:void(0)" icon="fa-solid fa-envelope-circle-check" title="Email has been sent"
        value="{{ @$sessionData['total_sent'] }}" variant="success" :currency=false />
</div>
<div class="col-sm-6">
    <x-panel.ui.widget.four url="javascript:void(0)" icon="fa-solid fa-paper-plane" title="Email has yet to be sent"
        :currency=false value="{{ @$sessionData['total_subscriber'] - @$sessionData['total_sent'] }}"
        variant="warning" />
</div>
<div class="col-sm-6">
    <x-panel.ui.widget.four url="javascript:void(0)" icon="fas fa-envelope" title="Email per batch"
