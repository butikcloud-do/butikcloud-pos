                    ...
                    <div class="card-body">
                        <form class="register" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn--primary btn-large w-100">@lang('Submit')</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        (function($) {
            ...
            $(document).on("change", "input[name='image']", function(e) {
                ...
                reader.onload = (e) => {
                    $(this).closest(".profile-image-group")
                        .find(".profile-image-thumb")
