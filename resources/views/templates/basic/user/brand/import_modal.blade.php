{{-- Brand Import Modal - Matching Product/Category Import Modal Style --}}
{{-- Hidden by default to prevent flash during page load --}}
<div id="importBrandModal" class="modal fade custom--modal" tabindex="-1" role="dialog" style="display: none;">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang('Import Brands')</h5>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <i class="las la-times"></i>
                </button>
            </div>
            <form action="{{ route('user.brand.import.store') }}" method="POST" enctype="multipart/form-data" class="brand-import-form">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="alert alert-info mb-4">
                        ...
                        <ul class="mb-0 ps-3">
                            ...
                            <li>@lang('Required fields: Name')</li>
                            <li>@lang('Name must be unique and under 40 characters')</li>
                            <li><strong>@lang('Transaction Rule:')</strong> @lang('If ANY brand fails validation, the ENTIRE import will be rejected (no partial imports)')</li>
                        </ul>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <a href="{{ route('user.brand.import.sample') }}" class="btn btn-outline--success btn-sm">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn--primary btn-large import-submit-btn">
                        <i class="las la-file-import me-1"></i> @lang('Import Brands')
                    </button>
                </div>
            </form>
        </div>
...
<script>
    "use strict";
    (function($) {
        const $importForm = $('.brand-import-form');
        ...
        const importText = @json(__('Import Brands'));
        ...
        $('#importBrandModal').on('show.bs.modal', function() {
            resetModalState();
        });
