{{-- Staff Import Modal - Matching Category/Brand/Customer Import Modal Style --}}
{{-- Hidden by default to prevent flash during page load --}}
<div id="importStaffModal" class="modal fade custom--modal" tabindex="-1" role="dialog" style="display: none;">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang('Import Staff')</h5>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <i class="las la-times"></i>
                </button>
            </div>
            <form action="{{ route('user.staff.import.store') }}" method="POST" enctype="multipart/form-data" class="staff-import-form">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="alert alert-info mb-4">
                        ...
                        <ul class="mb-0 ps-3">
                            ...
                            <li>@lang('Required fields: First Name, Last Name, Username, Email Address, Country, Mobile.')</li>
                            <li>@lang('Country Name must be spelled correctly (e.g. United States) to assign correct codes.')</li>
                            <li><strong>@lang('Note:')</strong> @lang('New staff members will automatically receive an email with their login credentials.')</li>
                            <li><strong>@lang('Transaction Rule:')</strong> @lang('If ANY row fails validation, the ENTIRE import will be rejected.')</li>
                        </ul>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <a href="{{ route('user.staff.import.sample') }}" class="btn btn-outline--success btn-sm">
...
<script>
    "use strict";
    (function($) {
        const $importForm = $('.staff-import-form');
        ...
        const importText = @json(__('Import Staff'));
        ...
        $('#importStaffModal').on('show.bs.modal', function() {
            resetModalState();
        });
