...
@section('panel')
    ...
    <form method="POST" action="{{ route('user.staff.permissions.update', $staff->id) }}" id="permission-form">
                            @csrf
                                        ...
                                        <div class="border border-1 d-flex  p-3 h-100 flex-column rounded group-permission-list">
                                            <div class="py-2">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <p class="fs-18 mb-0">{{ __(keyToTitle($k)) }}</p>
                                                    <div class="form-check form-switch form--switch pl-0 form-switch-success">
...
@push('breadcrumb-plugins')
    <x-back_btn route="{{ route('user.staff.list') }}" />
@endpush
