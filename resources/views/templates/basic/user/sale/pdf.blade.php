...
<head>
    ...
    <title>@lang('Sale Invoice') - {{ $sale->invoice_number }}</title>
    <style>
        *,
        *::after,
        *::before {
...
<body>
    @php
        $companyInformation = gs('company_information',getParentUser()->id);
    @endphp
                                        ...
                                        @foreach ($sale->payments as $payment)
                                            <ul class="invoice-payment-info">
                                                ...
                                                <li class="invoice-payment-info__item">
                                                    ...
                                                    <span
                                                        class="value">{{ gs('cur_sym',getParentUser()->id) }}{{ showAmount($payment->amount, currencyFormat: false) }}</span>
                                                </li>
                                                <li class="invoice-payment-info__item">
                                    ...
                                    <div class="invoice-payment float-end me-5">
                                        ...
                                        <ul class="invoice-payment-info">
                                            <li class="invoice-payment-info__item">
                                                ...
                                                <span
                                                    class="value">{{ gs('cur_sym',getParentUser()->id) }}{{ showAmount($sale->total, currencyFormat: false) }}</span>
                                            </li>
                                            <li class="invoice-payment-info__item">
                                                <span class="label">@lang('Total Paid'):</span>
                                                <span
                                                    class="value">{{ gs('cur_sym',getParentUser()->id) }}{{ showAmount($sale->payments->sum('amount'), currencyFormat: false) }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
                                    ...
                                    <div class="invoice-pricing float-end">
                                        ...
                                        <ul class="invoice-pricing-info ms-auto">
                                            <li class="invoice-pricing-info__item">
                                                ...
                                                <span
                                                    class="value">{{ gs('cur_sym',getParentUser()->id) }}{{ showAmount($sale->subtotal, currencyFormat: false) }}</span>
                                            </li>
                                            <li class="invoice-pricing-info__item">
                                                <span class="label">@lang('Discount'):</span>
                                                <span class="value">
                                                    {{ gs('cur_sym',getParentUser()->id) }}{{ showAmount($sale->discount_amount, currencyFormat: false) }}
                                            ...
                                            <li class="invoice-pricing-info__item">
                                                ...
                                                <span
                                                    class="value">{{ gs('cur_sym',getParentUser()->id) }}{{ showAmount($sale->shipping_amount, currencyFormat: false) }}</span>
                                            </li>
