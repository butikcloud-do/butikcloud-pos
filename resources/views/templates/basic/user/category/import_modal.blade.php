{{-- Category Import Modal - Matching Product Import Modal Style --}}
{{-- Hidden by default to prevent flash during page load --}}
<div id="importCategoryModal" class="modal fade custom--modal" tabindex="-1" role="dialog" style="display: none;">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang('Import Categories')</h5>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <i class="las la-times"></i>
                </button>
            </div>
            <form action="{{ route('user.category.import.store') }}" method="POST" enctype="multipart/form-data" class="category-import-form">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="alert alert-info mb-4">
                        ...
                        <ul class="mb-0 ps-3">
                            ...
                            <li><strong>@lang('Transaction Rule:')</strong> @lang('If ANY category fails validation, the ENTIRE import will be rejected (no partial imports)')</li>
                        </ul>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <a href="{{ route('user.category.import.sample') }}" class="btn btn-outline--success btn-sm">
...
<script>
    "use strict";
    (function($) {
        const $importForm = $('.category-import-form');
        ...
        const importText = @json(__('Import Categories'));
        ...
        $('#importCategoryModal').on('show.bs.modal', function() {
            resetModalState();
        });
