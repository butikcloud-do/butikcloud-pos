            ...
            <tbody>
                <tr>
                    <td class="w-50 align-middle">
                        <img class="invoice-logo float-start"
        ...
        <div class="totals">
            <div class="totals-wrapper">
                <table class="totals-table">
                    <tr>
                        <td>@lang('Subtotal')</td>
                        <td class="text-end">{{ showAmount($subscription->amount, forceDefault: true) }}</td>
                    </tr>
                    <tr>
                        <td>@lang('Discount')</td>
                        <td class="text-end">{{ showAmount($subscription->discount_amount, forceDefault: true) }}</td>
                    </tr>
                    <tr>
                        <td>@lang('Tax')</td>
                        <td class="text-end">{{ showAmount(0, forceDefault: true) }}</td>
                    </tr>
                    <tr>
