...
@section('panel')
    @include('Template::user.subscription.invoice_details')
    <div class="invoice-footer">
        <div class="flex-end gap-2">
            <a href="{{ route('user.subscription.invoice.download', $subscription->id) }}"
                class="btn btn--primary btn-large"><i class="las la-file-pdf"></i>
                @lang('PDF')
            </a>
