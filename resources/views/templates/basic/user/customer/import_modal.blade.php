{{-- Customer Import Modal - Matching Category/Brand Import Modal Style --}}
{{-- Hidden by default to prevent flash during page load --}}
<div id="importCustomerModal" class="modal fade custom--modal" tabindex="-1" role="dialog" style="display: none;">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang('Import Customers')</h5>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <i class="las la-times"></i>
                </button>
            </div>
            <form action="{{ route('user.customer.import.store') }}" method="POST" enctype="multipart/form-data" class="customer-import-form">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="alert alert-info mb-4">
                        ...
                        <ul class="mb-0 ps-3">
                            ...
                            <li>@lang('Required fields: Name, Mobile')</li>
                            <li>@lang('Optional fields: Email, Address, City, State, Zip, Postcode, Country')</li>
                            <li>@lang('Mobile and Email (if provided) must be unique')</li>
                            <li><strong>@lang('Transaction Rule:')</strong> @lang('If ANY customer fails validation, the ENTIRE import will be rejected (no partial imports)')</li>
                        </ul>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <a href="{{ route('user.customer.import.sample') }}" class="btn btn-outline--success btn-sm">
...
<script>
    "use strict";
    (function($) {
        const $importForm = $('.customer-import-form');
        ...
        const importText = @json(__('Import Customers'));
