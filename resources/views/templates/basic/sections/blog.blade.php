@php
    ...
    $blogElements = getContent('blog.element', false, orderById: true)->take(3);
@endphp
        ...
        <div class="row gy-4 justify-content-center">
            @foreach ($blogElements as $blogElement)
                <div class="col-md-6 col-xl-4 col-sm-12">
                    <div class="post-item wow animationfadeUp" data-wow-delay="0.4s">
                            ...
                            <div class="meta-post">
                                <div class="date blog-date">
                                    <span class="d-inline-block">
                                        ...
                                        {{ showDateTime($blogElement->created_at, format: 'M d , Y') }}
                                    </span>
                                </div>
                            </div>
