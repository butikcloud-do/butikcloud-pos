...
class AdminController extends Controller
{
    ...
    public function subscriptionLog()
    {
        ...
        $baseQuery     = PlanPurchase::query();
        $subscriptions = (clone $baseQuery)->orderBy('id', getOrderBy())->with('user', 'gateway')->searchable(['subscriptionPlan:name', 'user:username'])->dateFilter()->paginate(getPaginate());
        ...
        return view('admin.subscription.subscription_log', compact('pageTitle', 'subscriptions', 'widget'));
    }
