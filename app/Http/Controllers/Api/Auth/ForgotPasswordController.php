...
class ForgotPasswordController extends Controller
{
    public function sendResetCodeEmail(Request $request)
    {
        ...
        if (!$user) {
            ...
            return jsonResponse("user_not_found", "error", $notify);
        }
        ...
        return jsonResponse("code_sent", "success", $response, [
            'email' => $email
        ]);
    }
    ...
    public function verifyCode(Request $request)
    {
        ...
        return jsonResponse("success", "success", $response);
    }
    ...
    public function reset(Request $request)
    {
        ...
        if (!$reset) {
            ...
            return jsonResponse("invalid_code", "error", $response);
        }
        ...
        return jsonResponse("password_changed", "success", $response);
    }
